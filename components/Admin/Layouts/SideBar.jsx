...
export default function SideBar({ menuOpen }) {
  return (
    ...
    >
      ...
      <div>
        {/* Sidebar Title */}
        <div className="text-xl font-bold mb-6 text-gray-900 tracking-wide no-underline text-white">
          Admin Panel
        </div>
        ...
        <nav className="flex flex-col space-y-2">
          <Link
            href="/"
            className="flex items-center space-x-3 hover:bg-gray-100 p-3 rounded-lg transition no-underline text-white"
          >
      ...
      <div className="border-t border-gray-200 pt-4">
        <Link
          href="/logout"
          className="flex items-center space-x-3 hover:bg-red-600 bg-red-500 p-3 rounded-lg text-white transition"
        >
