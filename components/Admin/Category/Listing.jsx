...
import { categoryList } from "../../../utils/fetchAdminApi";
...
export default function Listing() {
  ...
  const handleDelete = async (id) => {
    await confirmDelete(`/delete/category/${id}`, fetchCategories);
  };
      ...
      <div className="bg-[#111] border border-yellow-500 shadow-lg rounded-xl p-6">
        ...
        <div className="mb-6 flex justify-between items-center">
          ...
          <div className="flex space-x-2">
            ...
            {/* Create Button */}
            <Link
              href="/administor/category/create"
                      ...
                      >
                        ...
                        <td className="p-3 text-center">
                          <div className="flex justify-center space-x-2">
                            <Link
                              href={`/administor/category/edit?id=${cat.id}`}
