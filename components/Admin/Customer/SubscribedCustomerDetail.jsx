        ...
        {loading ? (
          ...
          <>
            ...
            <div className="mb-6">
              ...
              <div className="p-4 bg-green-50 border rounded-lg text-gray-600">
                <p>
                ...
                <p>
                  <span className="font-medium">Price:</span> ${customer.price}
                </p>
                <p>
            ...
            <div>
              ...
              <div className="p-4 bg-gray-50 border rounded-lg text-gray-600">
                ...
                <p>
                  ...
                  {customer.payment_intent || "N/A"}
                </p>
                <p>
                  <span className="font-medium">Start Date:</span>{" "}
                  {customer.start_date || "Not Started"}
                </p>
                <p>
                  <span className="font-medium">End Date:</span>{" "}
                  {customer.end_date || "Not Ended"}
                </p>
                <p>
                  <span className="font-medium">Created At:</span>{" "}
                  {new Date(customer.created_at).toLocaleString()}
