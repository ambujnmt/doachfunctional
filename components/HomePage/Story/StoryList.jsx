...
import { storiesHomePage } from "../../../utils/fetchApi"; // Your API function
                                    ...
                                    <div key={story.id} className="col-span-12 xl:col-span-4 md:col-span-6 lg:col-span-4">
                                        <div className="bg-[#FFC32B] rounded-3xl">
                                            ...
                                            <div className="p-3">
                                                ...
                                                <p className="text-[14px] font-medium text-black mb-1">{story.date}</p>
                                                ...
                                                <Link href={story.link || "#"} className="flex justify-end text-[14px] font-medium text-black">
