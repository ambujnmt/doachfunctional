  ...
  return (
    <section className="loginForm">
      <div className="relative min-h-screen flex items-center justify-center bg-[#FFC32B] overflow-hidden">
          {/* Card */}
          <div className="bg-white shadow-xl rounded-2xl w-full max-w-md flex z-10">
            {/* Right Side Form */}
            <div className="w-full p-10 bg-black rounded-2xl">
              <div className="flex flex-col items-start justify-center w-full">
                ...
                <form className="w-full" onSubmit={handleSubmit}>
                  ...
                  <button
                    ...
                    hover:border border-yellow-600 duration-300 hover:!text-white disabled:opacity-50"
                  >
                  ...
                  <div className="mt-3">
                    <p className="text-center text-white text-sm">
                      ...
                      <Link
                        href="/signUp"
                        className="text-gray-300 hover:text-yellow-600 underline"
                      >
                        Create Account
                      </Link>
                    </p>
