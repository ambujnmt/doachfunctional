              ...
              <form className="w-full" onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none text-sm bg-transparent text-white"
                  />
                  {/* {errors.name && (
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex justify-center items-center gap-2 font-bold w-full text-[15px] my-2 text-center text-black rounded-[600px] bg-[#FFC32B] hover:bg-[#000] py-2 hover:border hover:!text-white disabled:opacity-50"
                >
